        ...
        <div class="news">
            ...
            <ul class="news__list row">
                <li v-for= "article in articles"
                    class="news__item col-sm-12 col-md-4 mb-2">
                    <div class="news__item_body p-1">
                        <div class="text-left p-2"><strong>{{ article.title }}</strong></div>
                        <img class="card-img" :src="article.urlToImage" alt="News Image" />
